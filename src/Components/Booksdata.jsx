...
const Booksdata = ({ title, inputValue }) => {
    ...
    return (
        <div className='mt-10 p-5 font-Poppins bg-gray-900'>
            <div className='flex justify-between items-center'>
                <h2 className='font-Poppins font-medium text-3xl text-white'>{title ? title : 'Popular Books'}</h2>
                {title ? '' : <Link to='/browsebook'><p className='text-orange-500 font-normal text-base underline underline-offset-1'>View more</p></Link>}
            </div>
